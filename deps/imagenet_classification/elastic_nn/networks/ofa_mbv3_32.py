...
from deps.utils import MyGlobalAvgPool2d, MyNetwork, SEModule, make_divisible, val2list
...
class OFAMobileNetV332(MobileNetV3):
    def __init__(
        self,
        n_classes=1000,
        bn_param=(0.1, 1e-5),
        ...
        super(OFAMobileNetV332, self).__init__(
    ...
    def config(self):
        return {
            "name": OFAMobileNetV332.__name__,
    ...
    def load_state_dict(self, state_dict, **kwargs):
        ...
        super(OFAMobileNetV332, self).load_state_dict(model_dict)
