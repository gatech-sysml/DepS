...
__all__ = ["ImageWoofDataProvider"]


class ImageWoofDataProvider(DataProvider):
    DEFAULT_PATH = "/nethome/sannavajjala6/data/imagewoof2/"
    ...
    def save_path(self):
        if self._save_path is None:
            ...
            if not os.path.exists(self._save_path):
                self._save_path = "/home/akhare39/data/imagewoof2/"
