...
__all__ = [
    ...
    "DistributedMetric",
    "DistributedTensor",
    "TrackDistributedMetric",
    "get_scaling_factor",
]


def get_scaling_factor(model_init, max_tuple, current_tuple):
    """
    Each tuple is of the form (in, out) so max_tuple = (max_in_channel, max_out_channel) and current_tuple = (in_channel, out_channel)
    """
    if model_init == "he_fout":
        return 1.0
        # return math.sqrt(max_tuple[1]/current_tuple[1])
    elif model_init == "he_fin":
        return 1.0
        # return math.sqrt(max_tuple[0]/current_tuple[0])
    else:
...
class TrackDistributedMetric(object):
    """
    Horovod: average metrics from distributed training.
    """
